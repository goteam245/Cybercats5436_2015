...
public class Gamepad {
	...
	/**
	 * XBOX 360 Left Stick Analog Button
	 */
	private static final int BUTTON_STICK_RIGHT = 10;
	/**
	 * XBOX 360 Right Stick Analog Button
	 */
	...
	public double getTriggers() {
		return deaden(joy.getRawAxis(AXIS_TRIGGERSR)-joy.getRawAxis(AXIS_TRIGGERSL));
	}
	...
	public boolean getLeftStick() {
		return joy.getRawButton(BUTTON_STICK_LEFT);
	}
	/**
	 *
	 * @return Is the left bumper pressed? [top one]
	...
	public boolean getRightStick() {
		return joy.getRawButton(BUTTON_STICK_RIGHT);
	}
	/**
	 *
	 * @return Is the left bumper pressed? [top one]
